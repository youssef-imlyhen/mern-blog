...
const CONNECTION_URL = "mongodb+srv://usf:usf@cluster0.rjozu.mongodb.net/mern_blog?retryWrites=true&w=majority";
...
const createADemo =async () => {
  let obj = {
    title: "latest psot", descreption: "latest app it's working", selectedFile: "just a test", author: "it's me", content: `<h1 class="heading">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptate, quos!</h1>
...
const { title, descreption, selectedFile, author, content, tags } = obj;
const newPostMessage = new PostMessage({ title, descreption, author, content, tags, selectedFile })
